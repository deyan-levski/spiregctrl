...
public class RegisterControl {
	...
	private void initialize() {
		...
		gbc_verticalGlue.gridheight = 24;
		...
		gbc_verticalGlue_1.gridheight = 24;
		...
		gbc_SREG_93.gridx = 7;
		gbc_SREG_93.gridy = 22;
		frame.getContentPane().add(SREG_93, gbc_SREG_93);

		Label label_1 = new Label("HEX Output:");
		...
		gbc_sendButton.gridy = 24;
		frame.getContentPane().add(sendButton, gbc_sendButton);

		Label label_2 = new Label("Binary Output:");
